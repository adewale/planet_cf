...
TEMPLATE_FEED_RSS10  # unused variable (RSS 1.0 feed template, available for use)
THEME_CSS  # unused variable (per-theme CSS mappings, available for use)
THEME_LOGOS  # unused variable (per-theme logo paths, available for use)
THEME_ASSETS  # unused variable (per-theme asset paths, available for use)
